...
- A `PDF <../latex/rhizobabel.pdf>`_ version of |rhizobabel| documentation is 
  available.

.. seealso::

   More documentation can be found on the
   `openalea <http://openalea.gforge.inria.fr/dokuwiki/doku.php?id=packages::rhizobabel:rhizobabel>`__ wiki.
