...
# * name is the full name (e.g., RhizoBabel) whereas pkg_name is only 'rhizobabel'
...
setup(
    ...
    entry_points = { 
        #'wralea' : ['rhizobabel = rhizobabel_wralea' if has_project else 'rhizobabel = rhizobabel_wralea' ],
        #'console_scripts': [
